...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    def get_Customers(self,objec):
        ...
        for i in objec:
            ...
            "user_id":(i.user_id).username, #!!!----not serelayzable whithout "str"----!!!!  make sure you fix it
    ...
    def get_Customers_by_username(self,obj):
        res=[]
        for iii in obj:
            res.append(
             {
                "id": iii._id,
                "status": str(iii.status),
                "first_name": iii.first_name,
                "last_name": iii.last_name,
                "address": iii.address,
                "phone_no": iii.phone_no,
                "first_name": iii.first_name,
                "credit_card_no": iii.credit_card_no,
                "user_id":(iii.user_id_id), #!!!----not serelayzable whithout "str"----!!!!  make sure you fix it
                "createdTime": iii.createdTime
...
class Airline_CompaniesSerializer(serializers.ModelSerializer):
    ...
    def get_airline_company_by_user_id(self,user_id):
        print(user_id)
        users= Airline_Companie.objects.filter(user_id = user_id)
        res=[]
        for user in users:
            res.append({
                "id": user._id,
...
class FlightsSerializer(serializers.ModelSerializer):
    ...
    def get_Flights_by_airline_id(self,obj):
       # ('id','status','airline_company_id','origin_country_id','destination_country_id','departure_time','landing_time','remaining_tickets','createdTime')
        res=[]
        for country in obj:
            res.append(
...
# get_flights_by_parameters-Done
    def get_Flights_by_parameters(self,objec):
        # filterFlight= Flight.objects.filter(origin_country_id=origin_country_id )
        # print(origin_country_id)
        # country= Flight.objects.filter(origin_country_id= origin_country_id)
       # ('id','status','airline_company_id','origin_country_id','destination_country_id','departure_time','landing_time','remaining_tickets','createdTime')
        for i in objec:
            res=[]
            res.append({
